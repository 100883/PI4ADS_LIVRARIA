...
public class Autor {
    ...
    public Autor() {
     ...
     //Para  teste JUnit
    public Autor(String nome, String nacionalidade, Date dataNascimento, boolean status, String descricao) {
        this.nome = nome;
    ...
    //Para  teste JUnit
    public Autor(String nome, String nacionalidade, String descricao) {
        this.nome = nome;
        this.nacionalidade = nacionalidade;
        this.descricao = descricao;
    }
