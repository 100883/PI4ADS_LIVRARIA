...
public class AutorBusiness {
    ...
    public Autor Consultar(int codigo) throws SQLException, Exception {
        return autorDAO.ConsultarPorCodigo(codigo);
    }

    public List<Autor> listar(String nome) throws  SQLException, Exception {
        return autorDAO.Listar();
    }

    private boolean validar(Autor autor) throws SQLException, Exception {
