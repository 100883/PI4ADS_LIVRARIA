...
public class LivroBusiness {
    ...
    public Livro Consultar(int codigo) throws SQLException, Exception {
        return livroDAO.ConsultarPorCodigo(codigo);
    }

    public List<Livro> listar(String nome) throws SQLException, Exception {
        return livroDAO.Listar();
    }

    private boolean validar(Livro livro) throws SQLException, Exception {
