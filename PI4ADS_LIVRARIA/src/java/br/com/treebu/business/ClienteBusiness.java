...
public class ClienteBusiness {
    ...
    public Cliente Consultar(int codigo) throws SQLException, Exception {
        return ClienteDAO.ConsultarPorCodigo(codigo);
    }

    public List<Cliente> listar(String nome) throws SQLException, Exception {
        return ClienteDAO.Listar();
    }

    private boolean validar(Cliente cliente) throws SQLException, Exception {
