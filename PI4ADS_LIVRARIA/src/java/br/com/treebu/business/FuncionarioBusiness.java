...
public class FuncionarioBusiness {
    ...
    public Funcionario Consultar(int codigo) throws SQLException, Exception {
        return funcionarioDAO.ConsultarPorCodigo(codigo);
    }

    public List<Funcionario> listar(String nome) throws SQLException, Exception {
        return funcionarioDAO.Listar();
    }

    private boolean validar(Funcionario funcionario) throws SQLException, Exception {
