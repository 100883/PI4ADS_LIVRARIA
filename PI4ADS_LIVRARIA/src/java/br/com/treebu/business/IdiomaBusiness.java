...
public class IdiomaBusiness {
    ...
    public Idioma Consultar(int codigo) throws SQLException, Exception {
        return idiomaDAO.ConsultarPorCodigo(codigo);
    }

    public List<Idioma> listar(String nome) throws SQLException, Exception {
        return idiomaDAO.Listar();
    }

    private boolean validar(Idioma genero) throws SQLException, Exception {
