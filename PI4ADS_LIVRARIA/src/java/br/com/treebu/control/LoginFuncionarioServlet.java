...
public class LoginFuncionarioServlet extends HttpServlet {
    ...
    public LoginFuncionarioServlet() throws SQLException {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (loginDAO.validarLoginFuncionario(email, senha)) {
                HttpSession sessao = request.getSession();
                sessao.setAttribute("sessaoUsuario", email);

                RequestDispatcher dispatcher = request.getRequestDispatcher("HomeFuncionario.jsp");
