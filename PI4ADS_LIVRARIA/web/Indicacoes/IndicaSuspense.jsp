<%-- 
    Document   : IndicaSuspense
    Created on : 29/11/2017, 21:19:03
        ...
        <aside class="profile-card">
            ...
            <div class="profile-bio">
                <p>
                    ...
                    pelos dados que você informou a indicacao é Suspense
                </p>
                <a href="../EcommerceLivro.jsp"><button> Voltar</button></a>
            </div>
        </aside>
